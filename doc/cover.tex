...
\Abstract{Keywords}{medical imaging, melanoma, binary classification, deep learning, convolutional neural network, ISIC, transfer learning, ImageNet.}
         {Abstract}{\selectlanguage{english}Lorem}
